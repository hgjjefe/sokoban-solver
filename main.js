    ...
    document.querySelectorAll('.cell').forEach(cell => cell.addEventListener('click', function (event) {
        ...
        switch (dataType) {
            case 'floor':
                ...
                break;
            case 'wall':
                cell.setAttribute('data-type', 'block');
                break;
            case 'block':
                cell.setAttribute('data-type', 'target');
                break;
            case 'target':
                cell.setAttribute('data-type', 'player');
                break;
            case 'player':
                cell.setAttribute('data-type', 'target-block');
                break;
            case 'target-block':
                cell.setAttribute('data-type', 'target-player');
                break;
            case 'target-player':
                cell.setAttribute('data-type', 'floor');
                break;
...
const importFromUrl = () => {
    ...
    try {
        ...
        if (solverBtnGroup)
            solverBtnGroup.classList.remove('d-none');
